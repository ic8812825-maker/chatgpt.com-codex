...
for token in ["UseSplitBigGeometry && UseLegacySingleBigGeometry", "bigHarvestGrossRatio <= 1.0", "reserveGrowthRatio <= 1.0", "newFarCompressionRatio >= 1.0", "CloseBigCoreOnSmall + RemainBigCoreOnSmall"]:
