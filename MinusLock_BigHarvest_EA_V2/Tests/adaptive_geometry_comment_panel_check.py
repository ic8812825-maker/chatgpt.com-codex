...
for token in ['Configured:', 'Runtime:', 'Source:', 'ATRPoints=', 'WorkInitial=', 'WorkBigStart=', 'WorkBigStep=', 'WorkFar=', 'FallbackReason=', 'ClearReason=', 'GeometryActive=', 'GeometryCleared=']:
