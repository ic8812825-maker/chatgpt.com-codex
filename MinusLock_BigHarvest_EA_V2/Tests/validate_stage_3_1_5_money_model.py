...
def validate():
 ...
 results={name:owner() for name,owner in owners.items()};blockers=sorted(k for k,v in results.items() if not v);return scenarios,mutations,causal,material,guards(),restart,extended,pytest_run,results,blockers
