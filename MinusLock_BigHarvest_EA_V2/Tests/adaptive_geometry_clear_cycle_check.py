...
for token in ['bool CanClearCycleGeometry()', 'void ClearCycleGeometry(bool persist = false)', 'CLEAR_CYCLE_GEOMETRY_SKIPPED', 'ACTIVE_CONTEXT_OR_POSITIONS']:
...
assert 'ClearCycleGeometry(true);' in terminal_block
