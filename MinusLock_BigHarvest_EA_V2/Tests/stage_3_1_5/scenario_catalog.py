...
REQUIRED_EXECUTABLE_FIXTURES=(
 ...
 ('FOREIGN_ACCOUNT',lambda:_identity('account'),{'accepted':False,'identity':{'account':9,'symbol':'X','magic':2,'cycle':'C'}}),('FOREIGN_SYMBOL',lambda:_identity('symbol'),{'accepted':False,'identity':{'account':1,'symbol':'Y','magic':2,'cycle':'C'}}),('FOREIGN_MAGIC',lambda:_identity('magic'),{'accepted':False,'identity':{'account':1,'symbol':'X','magic':9,'cycle':'C'}}),('FOREIGN_CYCLE',lambda:_identity('cycle'),{'accepted':False,'identity':{'account':1,'symbol':'X','magic':2,'cycle':'Z'}}),('SOURCE_POOL',lambda:{**_allocation(),'pool_net':D('5')},{'available':D('4'),'residual':D('1'),'sources':1,'pool_net':D('5')}),('MULTI_SOURCE',lambda:_allocation(True),{'available':D('4'),'residual':D('1'),'sources':2}),('ALLOCATION',lambda:{**_allocation(),'records':1},{'available':D('4'),'residual':D('1'),'sources':1,'records':1}),('CONSUMPTION',_consume,{'available_before':D('4'),'consumed':D('2'),'available_after':D('2')}),('RESIDUAL',lambda:{'source':D('5'),'allocated':_allocation()['available'],'residual':_allocation()['residual']},{'source':D('5'),'allocated':D('4'),'residual':D('1')}),('PARTIAL_FILL',_partial,{'volume':D('.5'),'cost':D('-5')}),('FULL_FILL',lambda:_partial(False),{'volume':D('.5'),'cost':D('-5')}),('DUPLICATE_FILL',lambda:_partial(True),{'duplicate_blocked':True}),('RECONCILIATION_TRANSITION',_transition,{'state':'PENDING_RECONCILIATION','revision':1}),('HISTORY_REPLAY',lambda:{**_duplicate_deal(),'replay_count':0},{'first':True,'second':False,'money':D('5'),'replay_count':0}),('DUPLICATE_DEAL',_duplicate_deal,{'first':True,'second':False,'money':D('5')}),('DUPLICATE_EVENT',lambda:{**_transition(),'duplicate_noop':True},{'state':'PENDING_RECONCILIATION','revision':1,'duplicate_noop':True}),('RESTART_CRASH_POINT',lambda:{**_transition(),'serialized':True},{'state':'PENDING_RECONCILIATION','revision':1,'serialized':True}),('FINAL_CLOSE_PASS',lambda:{'recovery':D('5'),'reserve':_allocation()['available'],'allowed':True},{'recovery':D('5'),'reserve':D('4'),'allowed':True}),('FINAL_CLOSE_REJECTIONS',lambda:{'allowed':False,'reasons':('FOREIGN_IDENTITY',)},{'allowed':False,'reasons':('FOREIGN_IDENTITY',)}))
