...
aggressive_not_found = root / "Sets" / "USDJPY_M30_AGGRESSIVE_NOT_FOUND.txt"
assert aggressive_set.exists() or aggressive_not_found.exists(), "AGGRESSIVE set or not-found marker required"
