...
bool IsPendingContractState(EAState state)
{
   return (state == STATE_SPLIT_BIG_OPEN_CORE ||
           ...
           state == STATE_SMALL_CLOSE_DYNAMIC_SMALL ||
           state == STATE_SMALL_CLOSE_BIG_CORE_PART ||
...
bool PendingActionMatchesState(EAState targetState, PendingActionType actionType)
{
   switch(targetState)
   {
      ...
      case STATE_SMALL_CLOSE_DYNAMIC_SMALL:
         return actionType == PENDING_CLOSE_REVERSE_SMALL_FULL;
      case STATE_SMALL_CLOSE_BIG_CORE_PART:
         return actionType == PENDING_CLOSE_BIG_CORE_PARTIAL;
...
string PendingContractActionMatrix(EAState targetState)
{
   switch(targetState)
   {
      ...
      case STATE_SPLIT_BIG_HARVEST_CLOSE_SMALL_BASE: return "STATE_SPLIT_BIG_HARVEST_CLOSE_SMALL_BASE <-> PENDING_CLOSE_SMALL_BASE_FULL";
      case STATE_SMALL_CLOSE_DYNAMIC_SMALL: return "STATE_SMALL_CLOSE_DYNAMIC_SMALL <-> PENDING_CLOSE_REVERSE_SMALL_FULL";
      case STATE_SMALL_CLOSE_BIG_CORE_PART: return "STATE_SMALL_CLOSE_BIG_CORE_PART <-> PENDING_CLOSE_BIG_CORE_PARTIAL";
