...
input bool UseHybridGeometrySolver = false; // backward-compatible only; activation is UseHybridSplitBigGeometry
input double HybridPartialFarShare = 0.10;
input double HybridFinalReserveShare = 0.90;
input double HybridCarryShare = 0.00;
input double TargetNewFarRatio = 0.50;
...
input double HybridCoverageSafetyBufferMoney = 0.00;
input double HybridMinimumCoverageGainMoney = 0.00;
input double HybridCatchUpMarginSafetyPercent = 10.00;
input double HybridAllowedMarketCostDeteriorationMoney = 0.00;
input bool HybridCatchUpAssumeMarginOverlap = false;
...
input double HybridGapBufferPoints = 0.00;
