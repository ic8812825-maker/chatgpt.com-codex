...
HSBI_BasketMoneyResult InjectedBasket(const double recovery,const double margin,const double exposure,const double transition){HSBI_BasketMoneyResult b;ZeroMemory(b);b.status=HSBI_CALC_PASS;b.valid=true;b.brokerRuntimeConfirmed=true;b.basketNetMoney=recovery;b.recoveryMoney=recovery;b.totalMargin=margin;b.grossExposure=exposure;b.reserveGainMoney=MathMax(0.0,recovery);b.farLossIncreaseMoney=transition;b.transitionLoss=transition;b.safetyBuffer=1.0;b.reason=HSBI_REASON_OK;b.details="INJECTED_BROKER_CONTRACT";return b;}
HSBI_FutureSmallInput FutureSmall(){HSBI_FutureSmallInput x;ZeroMemory(x);x.currentFar=1.0;x.coreRatio=2.0;x.trendRatio=1.0;x.smallRatio=0.5;x.maxNewFarRatio=0.6;x.minimumCompressionLots=0.2;x.minimumCompressionRatio=0.2;x.maximumDepth=2;x.conservativeQ=0.5;x.volumeMin=0.01;x.volumeMax=10.0;x.volumeStep=0.01;x.tickSize=0.00001;x.farDirection=HSBI_DIRECTION_SELL;x.moneyState.recoveryMoney=10.0;x.moneyState.available=true;x.moneyState.fresh=true;x.moneyState.snapshotId=1;x.riskState.currentRisk=100.0;x.riskState.riskTolerance=0.1;x.riskState.currentGrossExposure=10.0;x.riskState.nextGrossExposureLimit=9.0;x.riskState.available=true;x.riskState.fresh=true;x.riskState.snapshotId=2;x.marginState.currentMargin=20.0;x.marginState.allowedMargin=100.0;x.marginState.available=true;x.marginState.fresh=true;x.marginState.snapshotId=3;x.controlPrice.symbol="TEST";x.controlPrice.selectedPrice=1.10002;x.controlPrice.tickSize=0.00001;x.controlPrice.valid=true;x.controlPrice.fresh=true;x.controlPrice.snapshotId=1;x.typedControlPrice=Control(HSBI_DIRECTION_SELL);x.broker=Broker();x.farCosts=ProjectedCosts();x.coreCosts=ProjectedCosts();x.trendCosts=ProjectedCosts();x.smallCosts=ProjectedCosts();x.farOpenPrice=1.10000;x.coreOpenPrice=1.10000;x.trendOpenPrice=1.10000;x.smallOpenPrice=1.10000;x.transitionLossCap=10.0;x.executionSafetyBuffer=0.1;x.expectedReserve=2.0;x.currentBigGross=3.0;x.currentGrossExposure=10.0;x.cycleId=11;x.stateRevision=4;x.planId=5;x.snapshotsFresh=true;x.brokerPropertiesValid=true;x.costsIncluded=true;x.roundingIncluded=true;x.terminalRouteAllowed=true;x.useInjectedBrokerProofs=true;for(int i=0;i<128;i++){double scale=MathPow(0.5,i);x.injectedBrokerProofs[i]=InjectedBasket(20.0+i*10.0,10.0*scale,4.5*scale,1.0*scale);}return x;}
HSBI_NewFarSolverInput NewFar(){HSBI_NewFarSolverInput x;ZeroMemory(x);x.oldFarDescriptor=Position(HSBI_ROLE_FAR,10,100,1.0);x.oldFarDescriptor.direction=HSBI_DIRECTION_SELL;x.originalBigCoreDescriptor=Position(HSBI_ROLE_BIG_CORE,77,88,1.0);x.originalBigCoreDescriptor.direction=HSBI_DIRECTION_BUY;x.actualBigCoreResidual=Position(HSBI_ROLE_BIG_CORE,77,88,0.5);x.actualBigCoreResidual.direction=HSBI_DIRECTION_BUY;x.smallTransitionPlan.planId=5;x.smallTransitionPlan.stateRevision=4;x.smallTransitionPlan.immutable=true;x.smallTransitionPlan.persisted=true;x.actualClosingDeals.sourceDealId=9;x.actualClosingDeals.fillsConfirmed=true;x.actualClosingDeals.actual=true;x.moneyState.available=true;x.moneyState.fresh=true;x.moneyState.snapshotId=1;x.allocationState.valid=true;x.allocationState.fresh=true;x.allocationState.revision=1;x.riskState.currentRisk=100.0;x.riskState.riskTolerance=1.0;x.riskState.currentGrossExposure=10.0;x.riskState.available=true;x.riskState.fresh=true;x.riskState.snapshotId=2;x.marginState.currentMargin=50.0;x.marginState.allowedMargin=100.0;x.marginState.available=true;x.marginState.fresh=true;x.marginState.snapshotId=3;x.controlPrice.symbol="TEST";x.controlPrice.selectedPrice=1.10002;x.controlPrice.tickSize=0.00001;x.controlPrice.valid=true;x.controlPrice.fresh=true;x.controlPrice.snapshotId=1;x.brokerProperties=Broker();x.futureSmallTemplate=FutureSmall();x.cycleId=11;x.planId=5;x.stateRevision=4;x.projectedVolume=0.3;x.maximumNewFarRatio=0.6;x.minimumCompressionLots=0.2;x.minimumCompressionRatio=0.2;x.absoluteLossCap=10.0;x.equityPercentCap=10.0;x.oldFarRiskCap=10.0;x.cumulativeCycleLossCap=10.0;x.brokerMoneyAvailable=true;x.moneyProofDigest="M";x.marginProofDigest="G";x.riskProofDigest="R";return x;}
HSBI_FutureSmallLevelInput LevelInput(const double far,const HSBI_BasketMoneyResult &proof){HSBI_FutureSmallInput fs=FutureSmall();HSBI_FutureSmallLevelInput x;ZeroMemory(x);x.levelIndex=1;x.farBefore=far;x.coreRatio=fs.coreRatio;x.trendRatio=fs.trendRatio;x.smallRatio=fs.smallRatio;x.broker=fs.broker;x.controlPrice=fs.typedControlPrice;x.farCosts=fs.farCosts;x.coreCosts=fs.coreCosts;x.trendCosts=fs.trendCosts;x.smallCosts=fs.smallCosts;x.farOpenPrice=fs.farOpenPrice;x.coreOpenPrice=fs.coreOpenPrice;x.trendOpenPrice=fs.trendOpenPrice;x.smallOpenPrice=fs.smallOpenPrice;x.moneyState=fs.moneyState;x.riskState=fs.riskState;x.marginState=fs.marginState;x.minimumCompressionLots=0.1;x.minimumCompressionRatio=0.1;x.maxNewFarRatio=0.6;x.transitionLossCap=10.0;x.executionSafetyBuffer=0.1;x.priorBigGross=3.0;x.priorGrossExposure=10.0;x.planId=5;x.stateRevision=4;x.useInjectedBrokerProof=true;x.injectedBrokerProof=proof;return x;}
...
void OnStart()
{
   ...
   HSBI_FutureSmallLevelInput li2=LevelInput(0.5,InjectedBasket(30.0,5.0,2.25,0.5));li2.moneyState.recoveryMoney=20.0;li2.riskState.currentRisk=15.5;li2.priorBigGross=2.5;li2.priorGrossExposure=4.5;HSBI_FutureSmallLevelResult lr2=HSBI_EvaluateFutureSmallLevel(li2);Check("T131","HSBI-FS-001",true,lr2.valid&&lr2.coreVolume<lr.coreVolume,"LEVEL_SPECIFIC_GEOMETRY");
   ...
   nf=NewFar();nf.futureSmallTemplate.farCosts.snapshotId=2;string digestCost=HSBI_NewFarInputDigest(nf);nf.futureSmallTemplate.farCosts.snapshotId=1;Check("T152","HSBI-NF-006",true,digestCost!=HSBI_NewFarInputDigest(nf),"CHANGED_COST_CHANGES_DIGEST");
   ...
   nf=NewFar();string digestPrice=HSBI_NewFarInputDigest(nf);nf.futureSmallTemplate.typedControlPrice.bid+=0.00001;Check("T155","HSBI-NF-006",true,digestPrice!=HSBI_NewFarInputDigest(nf),"CHANGED_PRICE_CHANGES_DIGEST");
