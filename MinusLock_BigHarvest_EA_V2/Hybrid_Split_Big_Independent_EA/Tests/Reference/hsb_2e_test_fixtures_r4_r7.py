"""Deterministic canonical R4-R7 fixtures."""
from hsb_2e_provenance_model_r4_r7 import *
from hsb_2e_economic_model_r4_r7 import HSBI_EconomicPolicy
...
def broker_fixture(scenario='BIG',money='9'):
    c={'accountLogin':1,'symbol':'EURUSD','magic':7,'cycleId':'C','transactionId':'TX','actionId':'A','stateRevision':3,'snapshotId':'S','snapshotRevision':2,'volumeStep':'.01','volumeMin':'.01','volumeMax':'10'}
    snap=HSBI_QuoteSnapshot(1,1,'EURUSD',7,'C',3,'S',2,D('1.1'),D('1.2'),1900,'TRUSTED_TERMINAL_SNAPSHOT').sealed();policy=HSBI_ExecutionPricePolicy(1,'EURUSD',5,D('.00001'),0,'BID','ASK','TRUSTED_TERMINAL_SNAPSHOT','S',2,1900,2200,'EXACT_CLOSE_SIDE','HSBI-PRICE-R7').sealed()
