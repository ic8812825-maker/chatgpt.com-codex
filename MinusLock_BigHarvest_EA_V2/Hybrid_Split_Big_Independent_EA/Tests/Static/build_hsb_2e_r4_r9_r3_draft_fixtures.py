...
def base():
 ...
 return {'schemaVersion':9,'scenario':'INITIAL','identity':{'account':10001,'symbol':'EURUSD','magic':8812825,'cycleId':'C1','transactionId':'T1','actionId':'A1','stateRevision':0,'snapshotRevision':1},'brokerProperties':{'tickSize':'0.00001','volumeStep':'0.01','volumeMin':'0.01','volumeMax':'100.00'},'snapshot':{'symbol':'EURUSD','magic':8812825,'bid':'1.10000','ask':'1.10020','timestamp':100},'policy':{'buySide':'BID','sellSide':'ASK','validFrom':90,'validUntil':120},'intent':{'intentId':'I1','ticket':101,'symbol':'EURUSD','magic':8812825,'requestedVolume':'1.00','created':95,'expires':115},'time':{'minimum':90,'maximum':120,'deal':105,'event':105},'ledger':ledger,'brokerProposal':broker,'economicProposal':economic,'allocation':allocation,'fsm':fsm,'persistence':{'stateRevision':1,'ledgerRoot':broker['ledgerRoot'],'previousStateDigest':'PREVIOUS_ANCHOR'},'authoritativeAnchor':{'ledgerRoot':broker['ledgerRoot'],'previousStateDigest':'PREVIOUS_ANCHOR','revision':1},'certificate':certificate}
