...
def run(root,fixture,baseline):
 ...
 v.exact('S038',dec,['if(!x.persistencePrepared)return HSBI_RuntimeReject','HSBI_DECISION_PERSISTENCE_REQUIRED'],['false && !x.persistencePrepared','if(x.persistencePrepared)'])
