#!/usr/bin/env python3
"""R10 acceptance independently derives every outcome from the normative case contract."""
...
import run_hsb_2e_r4_r9_r4a_r10_regressions as regress
import accept_hsb_2e_r4_r9_r4a_r7 as coverage7
CAT=ROOT/'Tests/Contracts/HSB_2E_R4_R9_R4A_R10_CASE_CONTRACT.json';PROTECTED=ROOT/'Tests/Contracts/HSB_2E_R4_R9_R4A_R10_PROTECTED_FILES.json';OUT=ROOT/'Tests/Evidence/R4A_R10/acceptance_result.json';BASE='8237e52bbbd3c7a4822c5189ee72969a43a4df5a'
