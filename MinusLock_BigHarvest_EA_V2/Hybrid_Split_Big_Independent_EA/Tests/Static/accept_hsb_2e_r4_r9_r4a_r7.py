#!/usr/bin/env python3
"""Read-only R7 acceptance; current regressions are executed, never loaded from evidence."""
import argparse,copy,hashlib,json,subprocess
from collections import defaultdict
from pathlib import Path
import verify_hsb_2e_r4_r9_r4a_r7 as v
import run_hsb_2e_r4_r9_r4a_r7_regressions as regress
ROOT=v.ROOT;BASE='9c788d33120fe709c51fa70aa724bd16edf030b1';OUT=ROOT/'Tests/Evidence/R4A_R7/acceptance_result.json'
...
def run(fs=None):
 ...
 protected=json.loads((ROOT/'Tests/Contracts/HSB_2E_R4_R9_R4A_R7_PROTECTED_FILES.json').read_text())['files'];m=[]
 for x in protected:
