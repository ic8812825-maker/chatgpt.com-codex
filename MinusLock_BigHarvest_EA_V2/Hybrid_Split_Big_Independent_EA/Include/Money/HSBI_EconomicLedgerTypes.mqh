...
string HSBI_BuildSourceDealKey(const HSBI_EconomicLedgerRecord &r){return r.symbol+"|"+LongToString(r.magic)+"|"+IntegerToString((int)r.cycleId)+"|"+IntegerToString((int)r.dealTicket);}
