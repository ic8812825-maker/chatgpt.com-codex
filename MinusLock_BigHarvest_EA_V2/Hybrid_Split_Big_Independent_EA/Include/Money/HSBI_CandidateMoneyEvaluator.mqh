...
struct HSBI_CandidateMoneyEvaluationResult{HSBI_CalculationStatus status;bool valid;HSBI_FutureSmallResult futureSmallProof;string moneyProofDigest;string marginProofDigest;string riskProofDigest;HSBI_ReasonCode reason;string details;};
