...
string HSBI_SerializeSnapshotIds(const HSBI_SnapshotRecord &s){return HSBI_UlongToString(s.cycleId)+"|"+HSBI_UlongToString(s.stateRevision)+"|"+HSBI_SerializeActionIds(s.pendingAction);}
#endif
