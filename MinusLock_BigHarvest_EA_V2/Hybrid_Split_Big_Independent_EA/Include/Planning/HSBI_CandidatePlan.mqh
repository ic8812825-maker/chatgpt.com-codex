...
string HSBI_CandidatePlanFingerprint(const HSBI_CandidatePlan &p){return IntegerToString((int)p.planId)+"|"+IntegerToString((int)p.cycleId)+"|"+IntegerToString((int)p.stateRevision)+"|"+p.positionFingerprint+"|"+IntegerToString((int)p.marketSnapshotId);}
