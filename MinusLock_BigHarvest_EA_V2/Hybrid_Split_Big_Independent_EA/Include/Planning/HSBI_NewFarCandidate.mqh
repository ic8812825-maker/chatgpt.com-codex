...
struct HSBI_NewFarCandidate{double candidateVolume;double normalizedVolume;double oldFarVolume;double compressionLots;double compressionRatio;double riskNext;double marginNext;HSBI_Status futureSmallStatus;HSBI_Status finiteCatchUpStatus;bool nextCycleFeasible;ulong sourceBigCoreIdentifier;ulong sourceBigCoreTicket;HSBI_Status validationStatus;HSBI_ReasonCode reason;int futureTransitionCount;double safetyBuffer;string candidateDigest;};
...
int HSBI_CompareCandidateTieBreak(const HSBI_NewFarCandidate &a,const HSBI_NewFarCandidate &b){if(a.normalizedVolume<b.normalizedVolume)return -1;if(a.normalizedVolume>b.normalizedVolume)return 1;if(a.riskNext<b.riskNext)return -1;if(a.riskNext>b.riskNext)return 1;if(a.marginNext<b.marginNext)return -1;if(a.marginNext>b.marginNext)return 1;return 0;}
#endif
