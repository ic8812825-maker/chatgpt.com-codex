<!-- HSB_2D_V1_R1_CANONICAL_STATUS_BEGIN -->
## Канонический текущий статус HSB.2D-V1-R1

Предыдущая HSB.2D-V1 acceptance сохранена ниже только как `HISTORICAL_SUPERSEDED`.

```text
CURRENT_STAGE=HSB.2D-V1-R1
...
END_TO_END_MUTATION_TESTING=PASS
MUTATIONS_REQUIRED=55
MUTATIONS_CAUGHT=55
MUTATIONS_SURVIVED=0
FALSE_PASS_COUNTEREXAMPLE_M001=CAUGHT
...
HSB.2D_V2=AWAITING_USER_APPROVAL
HSB.2E=NOT_STARTED
...
```
<!-- HSB_2D_V1_R1_CANONICAL_STATUS_END -->
