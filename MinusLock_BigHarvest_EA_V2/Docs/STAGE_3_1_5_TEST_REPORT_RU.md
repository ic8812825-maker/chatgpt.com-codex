...
## Шестая проверка (3.1.5.123)

`STAGE_PYTEST=347/347`, `PROJECT_PYTEST=738/738`, `EXPLOIT_REGRESSIONS=PASS`, `CORRELATED_PERSISTENCE_ATTACKS=PASS`, `STANDALONE=171 PASS / 10 KNOWN FAIL`, `NEW_FAILURES=0`.

## Седьмая проверка (3.1.5.139)

`STAGE_PYTEST=351/351`, `PROJECT_PYTEST=742/742`, `FINAL_CLOSE_CORRUPTED_STORE_REJECTION=PASS`, `NEGATIVE_CAUSAL_CONTROLS=PASS`, `STANDALONE=171 PASS / 10 KNOWN FAIL`, `NEW_FAILURES=0`.
