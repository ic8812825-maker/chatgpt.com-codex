...
## Результат корректирующей приёмки 3.1.5.38

`PREVIOUS_STAGE_3_1_5_PASS=SUPERSEDED`; `STAGE_3_1_5_STATUS=CLOSED`;
`NEXT_ALLOWED_STAGE=3.1.6`; `STAGE_3_1_6_STARTED=NO`; `AWAITING_USER_APPROVAL=YES`;
`REAL_TRADING_ALLOWED=NO`; exact MT5 runtime execution не доказан.

## Вторая коррекция 3.1.5.39

`PUBLISHED_3_1_5_38_PASS=SUPERSEDED`; `STAGE_3_1_5_STATUS=REOPENED_FOR_CORRECTION`;
`NEXT_ALLOWED_STAGE=NONE`; `STAGE_3_1_6_START_ALLOWED=NO`; `REAL_TRADING_ALLOWED=NO`.

## Подтверждённое закрытие 3.1.5.58

`STAGE_3_1_5_STATUS=CLOSED`; `NEXT_ALLOWED_STAGE=3.1.6`; `STAGE_3_1_6_STARTED=NO`;
`AWAITING_USER_APPROVAL=YES`; `REAL_TRADING_ALLOWED=NO`.

## Третья коррекция 3.1.5.59

`PUBLISHED_3_1_5_58_PASS=SUPERSEDED`; `STAGE_3_1_5_STATUS=REOPENED_FOR_CORRECTION`;
`NEXT_ALLOWED_STAGE=NONE`; `STAGE_3_1_6_START_ALLOWED=NO`; `REAL_TRADING_ALLOWED=NO`.
