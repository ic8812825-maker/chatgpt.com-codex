...
def main() -> None:
    ...
    mc_lines = [
        ...
        "| scenario | E[ΔV] | worst ΔV | collapse | recovery_speed | control_intensity |",
        "|---|---:|---:|---:|---:|---:|",
    ]
    for r in mc:
        mc_lines.append(f"| {r['mode']} | {r['E_dV']:.6f} | {r['worst_dV']:.6f} | {r['collapse']:.4f} | {r['recovery_speed']:.4f} | {r['control_intensity']:.4f} |")
