...
inputs = [
    ...
    ("Edge drift μ (в цену/шаг)", 0.00003), ("Комиссия на 1 лот/шаг, USD", 0.40),
    ("Проскальзывание на 1 лот/шаг, USD", 0.20), ("Горизонт T (шаги)", 100),
]
...
calc_rows = [
    ...
    ("k(ATR)", "=Ввод!B24+(Ввод!B25-Ввод!B24)*EXP(-Ввод!B26*B22)"),
    ...
    ("Интеграл экспозиции ∫Qdt (proxy)", "=B15*Ввод!B32"),
    ("Cost rate/шаг, USD (proxy)", "=ABS(B15)*(Ввод!B15*Ввод!B6 + Ввод!B30 + Ввод!B31)"),
    ("Интеграл издержек ∫Cost dt", "=B27*Ввод!B32"),
    ("EV(T) = μ∫Qdt - ∫Costdt", "=Ввод!B29*B26 - B28"),
    ("Условие +EV", "=IF(B29>0,\"YES\",\"NO\")"),
]
